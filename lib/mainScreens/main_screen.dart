...
import 'package:usrs_app/assistants/assistant_methods.dart';
import 'package:usrs_app/constants/constant_color.dart';
import 'package:usrs_app/global/global.dart';
import 'package:usrs_app/mainScreens/rate_driver_screen.dart';
import 'package:usrs_app/mainScreens/search_places_screen.dart';
import 'package:usrs_app/mainScreens/select_nearest_active_driver_screen.dart';
import 'package:usrs_app/widgets/pay_fare_amount_dialog.dart';
...
class _MainScreenState extends State<MainScreen> {
            ...
            if (eventSnapshot.snapshot.value == "idle") {
              ...
              showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: Text(
                        '"The driver has cancelled your request.' +
  ...
  showUIForAssignedDriverInfo() {
    setState(() {
      ...
      assignedDriverInfoContainerHeight = 290;
    });
  }
  ...
  showWaitingResponseFromDriverUI() {
    setState(() {
      searchLocationContainerHeight = 0;
      waitingResponseFromDriverContainerHeight = 290;
    });
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Divider(height: 2, thickness: 2, color: whiteColor),
  ...
  Future<void> drawPolyLineFromOriginToDestination() async {
    ...
    setState(() {
      tripDrictionDetailsInfo = directionDetailsInfo;
    });
